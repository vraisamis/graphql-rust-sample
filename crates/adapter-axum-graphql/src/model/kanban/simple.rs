...
impl QueryRoot {
    ...
    // ここから
    async fn get_user<'a>(&self, ctx: &Context<'a>, id: String) -> GqlResult<Option<User>> {
        let result = ctx
            .data::<Data>()?
            .users
            .iter()
    ...
    async fn get_board<'a>(&self, ctx: &Context<'a>, id: String) -> GqlResult<Option<Board>> {
        let result = ctx
            .data::<Data>()?
            .boards
            .iter()
    ...
    async fn get_column<'a>(&self, ctx: &Context<'a>, id: String) -> GqlResult<Option<Column>> {
        let result = ctx
            .data::<Data>()?
            .boards
            .iter()
